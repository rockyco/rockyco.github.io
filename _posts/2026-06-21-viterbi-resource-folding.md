...
from about 2,300 logic cells to roughly 740 - close to a two-thirds saving.
...
<figure>
  ...
  <figcaption>More folding, less logic - the area falls to a third while the clock stays in range.</figcaption>
</figure>
