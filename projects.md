...
### 📱 5G NR Signal Processing Applications

**Real-Time MATLAB Algorithm Development**

Comprehensive 5G NR development using Claude 3.7 Sonnet Thinking for complete automation without manual coding.

**Automated Capabilities:**
- **Multiple SSB signal processing** from over-the-air cellular transmissions
- **Rich visualization creation** of detected SSB signals  
...
- **Real-time 5G NR SSB detection** on FPGA hardware
- **Bridging theoretical analysis** with practical field applications
- **MATLAB's powerful reference designs** combined with Claude's code generation

### 🖼️ Advanced Image Processing Optimization

**Multi-Implementation Sobel Filter Study**

Comprehensive exploration of LLM-based optimization demonstrating dramatic memory and latency improvements through AI-guided design.

**Optimization Results:**
- **Memory-intensive baseline** → **Highly optimized version** guided by Gemini 2.0 Flash
- **Dramatic memory usage reduction** achieved through systematic LLM optimization
...
### 🏗️ Complete USRP X310 FPGA Deployment Pipeline
...
#### Space-Grade Algorithm Optimization  
...
#### BRAM Mapping Discovery
- **Critical finding**: FIFO size ≥16 entries prevents BRAM mapping for ENTIRE designs
...
## 💡 Development Evolution & Key Insights
